...
-- Se aplicó el filtro lógico AND (en comparación del día anterior donde se 
-- aplicó el filtro lógico OR) para seleccionar solo los productos que 
-- cumplen ambas condiciones (ser bajos en grasas y reciclables).
