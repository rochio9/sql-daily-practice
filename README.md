...
- `week-01-fundamentals/` — SELECT, WHERE, ORDER BY, NULL handling.
- `week-02-joins-aggregations/` — JOINs, GROUP BY, subqueries.
- `week-03-window-functions/` — RANK, LAG/LEAD, partitioning.
- `week-04-ctes-advanced/` — CTEs, recursión, gaps & islands.
- `notes/` — Apuntes temáticos.
